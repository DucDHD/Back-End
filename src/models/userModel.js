...
// Define tạm 2 roles cho user, tùy việc mở rộng dự án như thế nào mọi người có thể thêm role tùy ý sao cho phù hợp
const USER_ROLES = {
  CLIENT: 'client',
  ADMIN: 'admin'
}
...
const USER_COLLECTION_SCHEMA = Joi.object({
  ...
  // user cắt ra từ email sẽ có khẳ năng không unique bởi vì sẽ có những tên email trùng nhau nhưng từ các nhà cung cấp khác nhau
...
const createNew = async (data) => {
  try {
    // Kiểm tra dữ liệu tại model trước khi insert dữ liệu vào DB
